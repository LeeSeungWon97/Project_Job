				...
				<div class="card-body px-5 mt-1">
					...
					<div style="padding: 10px;" class="list-group reserveArea">
						<div class="row" style="padding: 10px; border-style: groove;">
							<div class="col-3">
								<button onclick="ViewReview('1')">인적성후기</button>
							</div>

							<div class="col-3">
								<button onclick="ViewReview('2')">면접질문</button>
							</div>

							<div class="col-3">
								<button onclick="ViewReview('3')">면접후기</button>
							</div>

							<div class="col-3">
								<button onclick="ViewReview('4')">최종합격후기</button>
							</div>
						</div>
