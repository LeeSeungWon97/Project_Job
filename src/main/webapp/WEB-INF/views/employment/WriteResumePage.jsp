...
<body>
	...
	<form action="${pageContext.request.contextPath }/WriteResume" method="post" onsubmit="">
							...
							<div class="input-group input-group-lg mb-3">
								...
								value="${sessionScope.loginInfo.mbirth}">
							</div> 
							
							<div class="input-group input-group-lg mb-3">
								<input type="text" class="form-control"  name="reedu"  placeholder="학력" >
							</div>
							<div class="input-group input-group-lg mb-3">
								<input type="text" class="form-control"  name="recarrer"  placeholder="경력" >
							</div>
							<div class="input-group input-group-lg mb-3">
								<input type="text" class="form-control"  name="react"  placeholder="인턴/대외 활동" >
							</div>
							<div class="input-group input-group-lg mb-3">
								<input type="text" class="form-control"  name="relicense"  placeholder="자격증" >
							</div>
							<div class="input-group input-group-lg mb-3">
