...
public class ArrEssayDto {
	...
	public String toString() {
		return "ArrEssayDto [esnum=" + esnum + ", esciname=" + esciname + ", esepnum=" + esepnum + ", esmid=" + esmid
				+ ", escontents=" + Arrays.toString(escontents) + ", esstate=" + esstate + "]";
	}
