...
public interface EmploymentDao {
	...
	@Select("SELECT EPNUM, EPNAME, EPCINAME, EPEDU, EPCAREER, EPTREAT, EPTYPE, EPMONEY, EPAREA, EPTIME, TO_CHAR(EPPOST,'YYYY-MM-DD') AS EPPOST, TO_CHAR(EPDEADLINE,'YYYY-MM-DD') AS EPDEADLINE, EPSTATE, EPESSTATE FROM EMPLOYMENT WHERE EPESSTATE = 'x' ORDER BY EPPOST DESC")
	ArrayList<EmploymentDto> getEpList();

	@Select("SELECT EPNUM, EPNAME, EPCINAME, EPEDU, EPCAREER, EPTREAT, EPTYPE, EPMONEY, EPAREA, EPTIME, TO_CHAR(EPPOST,'YYYY-MM-DD') AS EPPOST, TO_CHAR(EPDEADLINE,'YYYY-MM-DD') AS EPDEADLINE, EPSTATE, EPESSTATE FROM EMPLOYMENT WHERE EPESSTATE = 'Y' ORDER BY EPPOST DESC")
	...
	@Select("SELECT EPNUM, EPNAME, EPCINAME, EPEDU, EPCAREER, EPTREAT, EPTYPE, EPMONEY, EPAREA, EPTIME, TO_CHAR(EPPOST,'YYYY-MM-DD') AS EPPOST, TO_CHAR(EPDEADLINE,'YYYY-MM-DD') AS EPDEADLINE, EPSTATE, EPESSTATE FROM EMPLOYMENT WHERE EPNAME LIKE '%'||#{searchValue}||'%'")
	...
	@Select(" SELECT AP.APEPNUM, AP.APREMID,M.MNAME, EP.EPNAME,EP.EPNUM,TO_CHAR(EPDEADLINE,'YY-MM-DD') AS EPDEADLINE ,CI.CINAME,CI.CINUM , CM.CMID, M.MEMAIL, CM.CMEMAIL  "
			...
			+ " AND CI.CINUM = CM.CMCINUM " + " AND CMID = #{loginId} AND AP.APSTATE = 'N'")
	...
	@Select("SELECT EPNUM, EPNAME, EPCINAME, EPEDU, EPCAREER, EPTREAT, EPTYPE, EPMONEY, EPAREA, EPTIME, TO_CHAR(EPPOST,'YYYY-MM-DD') AS EPPOST, TO_CHAR(EPDEADLINE,'YYYY-MM-DD') AS EPDEADLINE, EPSTATE, EPESSTATE FROM EMPLOYMENT WHERE EPCINAME LIKE '%'||#{searchValue}||'%' ")
